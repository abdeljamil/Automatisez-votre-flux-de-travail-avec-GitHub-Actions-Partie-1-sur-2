...
1. In the **Code** tab of your repository, create a new branch named `welcome-workflow`.
   ...
   <img width="400" alt="create branch screenshot" src="https://github.com/abdeljamil/Automatisez-votre-flux-de-travail-avec-GitHub-Actions-Partie-1-sur-2/blob/main/.github/images/create-branch-screenshot.png?raw=true" />
